...
def test_with_projection_and_outlier_predicate():
    # QuackDB query
...
def test_with_projection_and_min_max_skipped_predicate():
    # QuackDB query
    start_time = time.time()
...
test_with_projection_and_outlier_predicate()
test_with_projection_and_min_max_skipped_predicate()