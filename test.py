...
def test_with_multiple_files_and_not_skipped_predicate():
    # QuackDB query
    start_time = time.time()
    quackdb_res = quackdb.sql("SELECT o_totalprice, o_orderkey FROM read_parquet(['/Users/umutozdemir/Desktop/theses/data/orders_1.parquet', '/Users/umutozdemir/Desktop/theses/data/orders_2.parquet']) WHERE o_totalprice > 50000")
    quackdb_time = time.time() - start_time
    print("QuackDB result:")
    print(quackdb_res)
    print(f"QuackDB query time: {quackdb_time:.3f} seconds\n")
    ...
    # DuckDB query
    start_time = time.time()
    duckdb_res = duckdb.sql("SELECT o_totalprice, o_orderkey FROM read_parquet(['/Users/umutozdemir/Desktop/theses/data/orders_1.parquet', '/Users/umutozdemir/Desktop/theses/data/orders_2.parquet']) WHERE o_totalprice > 50000")
    duckdb_time = time.time() - start_time
    print("DuckDB result:")
    print(duckdb_res)
    print(f"DuckDB query time: {duckdb_time:.3f} seconds")
...
def test_with_multiple_files_and_outlier_predicate():
    # QuackDB query
    start_time = time.time()
    quackdb_res = quackdb.sql("SELECT o_totalprice, o_orderkey FROM read_parquet(['/Users/umutozdemir/Desktop/theses/data/orders_1.parquet', '/Users/umutozdemir/Desktop/theses/data/orders_2.parquet']) WHERE o_totalprice > 421400")
    quackdb_time = time.time() - start_time
    print("QuackDB result:")
    print(quackdb_res)
    print(f"QuackDB query time: {quackdb_time:.3f} seconds\n")
    ...
    # DuckDB query
    start_time = time.time()
    duckdb_res = duckdb.sql("SELECT o_totalprice, o_orderkey FROM read_parquet(['/Users/umutozdemir/Desktop/theses/data/orders_1.parquet', '/Users/umutozdemir/Desktop/theses/data/orders_2.parquet']) WHERE o_totalprice > 421400")
    duckdb_time = time.time() - start_time
    print("DuckDB result:")
    print(duckdb_res)
    print(f"DuckDB query time: {duckdb_time:.3f} seconds")
